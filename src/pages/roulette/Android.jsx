...
import BoxAndroid from '../categories/BoxAndroid'
...
class Android extends Component {
  ...
  constructor(props){
    ...
    //this.db = firebase.database().ref().child('produsctsAndroid');
   
        firebase.database().ref().child('produsctsAndroid').on('child_added', function(snap){
          const  product = {
            
            name: snap.val().name,
            image: snap.val().picture
        }
      ...
      <Jumbotron />
        <div className="page">
            <section>
                ...
                <h1>Caja Android. Abre la caja y gana. Buena Suerte</h1>
        ...
        />
                      ...
                      <div key={property.index} className="col">
